...
class Config:
    ...
    file_names = ['CRISPR-based editing for inherited blood disorders.md', 'Health Impacts of Per- and Polyfluoroalkyl Substances (PFASs): A Comprehensive Review.md', 'Phthalates Toxicity.md']
