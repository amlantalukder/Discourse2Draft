...
def mod_create_account(input, output, session, config_app, changeView):
    ...
    def createAccount():
        ...
        insertIntoDB(table_name='settings', 
                     field_names=['email', 'llm', 'temperature', 'instructions', 'update_date'], 
                     field_values=[[email], [config_app.llm], [config_app.temperature], [config_app.instructions], [current_time]])
